...
Redacción de una idónea comunicación de resultados                                             & 18P        &  5-11   &    7 semanas     \\ \hline
\end{tabular}
}
\caption{Cronograma}
\end{table}
