...
Esta clase de problemas ha sido tradicionalmente atacada reduciendo el \textbf{POM} a un problema mono-objetivo (estrategias de suma agregativa ponderada, de restricciones-$\epsilon$,
...
\subsection{Métodos empleados para resolver el POM mejorando la diversidad de las soluciones}
...
(mejores soluciones actuales o los centros de las subpoblaciones) que restringen la generación de nuevas soluciones con base a un indicador, de forma que las nuevas soluciones aceptables
...
\section{Justificación e hipótesis}
...
% \end{itemize}
%  
El presente trabajo adquiere importancia con el estudio de los mecanismos que buscan preservar la diversidad de las soluciones en los principales marcos de trabajo en el estado del arte de \textbf{POM}. En particular,
...
\item Adaptar, implementar y determinar el comportamiento del método \emph{MOEA/D} para las instancias seleccionadas.
 
\item Adaptar, implementar y determinar el comportamiento del método \emph{NSGA-III} para las instancias seleccionadas.

\item Adaptar e implementar seis estrategias para generar vectores de pesos/puntos de referencia iniciales para \emph{MOEA/D} y \emph{NSGA-III}.
...
Particularmente, se realizará un análisis de la prueba de rangos con signo de Wilcoxon \cite{wilcoxon1945individual} de cada una de las técnicas implementadas, comparando su rendimiento contra algunas de las técnicas propuestas en la literatura.
...
\item[•] \textbf{Etapa 3.} \emph{Comparaciones de las técnicas y prueba de rangos con signo de Wilcoxon.}

\item [] Una vez que se tengan las estrategias implementadas, se realizarán experimentos computacionales sobre bancos de problemas clásicamente utilizados en la literatura, como por ejemplo: la suite DTLZ, la suite WFG o la suite UF (CEC'2009) \cite{coello2007evolutionary,zhang2008multiobjective}. Así, se podrán efectuar comparaciones sobre la calidad de las soluciones obtenidas por cada versión de los dos marcos de trabajo estudiados en terminos de algún indicador de diversidad, así como de la cantidad de recursos computacionales utilizados. Posteriormente, se justificará su rendimiento con un análisis estadístico detallado para cada versión implementada de los métodos de interés.
...
\item[] Una vez terminada la etapa de mejoras de cada una de las técnicas, se realizará un nueva prueba de rangos con signo de Wilcoxon para comparar el rendimiento de cada una de nuestras técnicas en terminos de algún indicador de diversidad, describiendo los resultados obtenidos.
...
Implementación de al menos dos técnicas de generación de los vectores de pesos/puntos de referencia& 18I        & 1-3   & 3 semanas     \\ \hline
...
Diseño de una estrategia de actualización de los vectores de pesos/puntos de referencia basada en \cite{ahrari2016multimodal} & 18I        & 10-11    &    2 semanas      \\ \hline
